...
export default function MapPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-20 space-y-16">
      ...
      <div className="max-w-3xl mx-auto text-center space-y-8 pt-12">
        <h3 className="text-3xl font-serif italic text-[#1A0E0C]">Mapping the Unseen</h3>
        <p className="text-lg text-[#2A1A18]/60 font-serif leading-relaxed">
          Every point holds a memory, a frame, or a distinct flavor. Use the interface controls embedded within the layout interface above to parse geographic updates natively across global coordinate systems.
        </p>
      </div>
    </div>
  );
