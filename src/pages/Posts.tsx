...
import PostCard from '../components/PostCard';
import { Input } from '@/components/ui/input';
import { Search, Calendar, Tag, Layers, Folder, ChevronRight } from 'lucide-react';
import { Tabs, TabsList, TabsTrigger, TabsContent } from '@/components/ui/tabs';
import { cn } from '@/lib/utils';
        ...
        <div className="flex justify-center">
          ...
          <div className="w-full overflow-x-auto md:overflow-visible scrollbar-none -mx-4 px-4 md:mx-0 md:px-0">
            <TabsList className="bg-[#F0E8E4] border border-[#A84848]/10 rounded-full p-1 h-16 flex w-max min-w-[500px] md:min-w-0 md:w-full md:grid md:grid-cols-4">
              ...
              <TabsTrigger 
                value="all" 
                className="rounded-full px-6 md:px-10 h-full text-sm font-serif tracking-widest uppercase data-[state=active]:bg-[#A84848] data-[state=active]:text-white transition-all whitespace-nowrap flex items-center justify-center"
              >
                <Layers size={16} className="mr-2 flex-shrink-0" /> All Posts
              </TabsTrigger>
              ...
              <TabsTrigger 
                ...
                className="rounded-full px-6 md:px-10 h-full text-sm font-serif tracking-widest uppercase data-[state=active]:bg-[#A84848] data-[state=active]:text-white transition-all whitespace-nowrap flex items-center justify-center"
              >
                <Folder size={16} className="mr-2 flex-shrink-0" /> Folders
              </TabsTrigger>
              ...
              <TabsTrigger 
                ...
                className="rounded-full px-6 md:px-10 h-full text-sm font-serif tracking-widest uppercase data-[state=active]:bg-[#A84848] data-[state=active]:text-white transition-all whitespace-nowrap flex items-center justify-center"
              >
                <Calendar size={16} className="mr-2 flex-shrink-0" /> Timeline
              </TabsTrigger>
              ...
              <TabsTrigger 
                ...
                className="rounded-full px-6 md:px-10 h-full text-sm font-serif tracking-widest uppercase data-[state=active]:bg-[#A84848] data-[state=active]:text-white transition-all whitespace-nowrap flex items-center justify-center"
              >
                <Tag size={16} className="mr-2 flex-shrink-0" /> Tags
              </TabsTrigger>
